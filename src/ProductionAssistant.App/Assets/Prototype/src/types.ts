...
export interface NotionFillJobDetail { id: string; name: string; baseUrl: string; sourcePageUrl: string; username: string; passwordConfigured: boolean; notionConfigured: boolean; targetDataSourceName: string; validated: boolean; isEnabled: boolean; schedulingAvailable: boolean; schedule: string; schedulerInstalled: boolean; schedulerMessage: string; runs: NotionFillRun[] }
...
export interface BindingState {
  ...
  usesBusinessSections: boolean
  businessSections: string[]
  sources: Array<{ id: string; name: string; path: string; businessSection: string }>
  selected: Record<string, string>
}

export interface WeldRow { date: string; weekday: string; isWeekend: boolean; qty: string; note: string }
export interface WeldState { configured: boolean; binding: BindingTarget; usesBusinessSections: boolean; businessSections: string[]; sources: Array<{ id: string; name: string; path: string; businessSection: string }>; selected: string }
